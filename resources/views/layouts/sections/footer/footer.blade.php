{{-- <!-- Footer -->
<div class="card shadow-sm border-0 mt-4"> <!-- Card wrapper -->
  <footer class="content-footer footer bg-footer-theme mb-0">
    <div class="{{ (!empty($containerNav) ? $containerNav : 'container-fluid') }}">
      <div class="footer-container d-flex align-items-center justify-content-between py-3 flex-md-row flex-column">
        ...
        <div class="text-body mb-2 mb-md-0">
          ...
          <span class="text-danger"><i class="tf-icons mdi mdi-heart"></i></span> by 
          <a href="{{ (!empty(config('variables.creatorUrl')) ? config('variables.creatorUrl') : '') }}" target="_blank" class="footer-link fw-medium">
